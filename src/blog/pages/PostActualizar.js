...
const PostActualizar = () => {
        ...
        setFormData(
          {
            ...
            seccion: {
              value: responseData.post.seccion,
              isValid: true,
            },
            resumen: {
  ...
  const selectHandler = (event) => {
    ...
    inputHandler("seccion", selectedValue, true);
  };
    ...
    try {
      ...
      await sendRequest(
        ...
        JSON.stringify({
          ...
          seccion: formState.inputs.seccion.value,
      ...
      history.push("/");
      history.replace(`publicacion/${postId}`);
    } catch (err) {}
  };
    ...
    <React.Fragment>
      ...
      {!isLoading && loadedPost && (
        <form className="post-form" onSubmit={postUpdateSubmitHandler}>
          ...
          <select
            id="seccion"
            initialValue={loadedPost.seccion}
            label="seccion"
            errorText="Por favor seleccione alguna categoría."
            onChange={selectHandler}
          >
            <option value="">Seleccione un departamento</option>
            <option value="inicio">Publicación de Inicio</option>
            <option value="destacada">Publicación destacada</option>
            <option value="titulacion">
              Publicación de Titulacion Principal
            </option>
            <option value="titulacion-general">
              Publicaciones de Titulación
            </option>
          </select>
          <br />
